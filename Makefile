...
#    Updated: 2022/05/04 01:23:48 by tmatis           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			= 	framework/graphic.c framework/log.c framework/mlx_hooks.c \
					render.c framework/draw_util/draw_util.c
...
$(NAME):	${OBJS} ${OBJ_MAIN} $(LIBMLX)
			@$(call display_progress_bar)
			@$(call run_and_test,$(CC) $(CFLAGS) $(DFLAGS) -I$(INCLUDE_PATH) -o $@ ${OBJS} ${OBJ_MAIN} $(LIBFLAG))
			@echo "                                                                       "
